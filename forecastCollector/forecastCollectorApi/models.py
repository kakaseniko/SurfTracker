...
class ForecastData(models.Model):
    ...
    def __str__(self):
        return self.country + " " + str(self.dateTime) + " " + str(self.waveHeight) + " " + str(self.wavePeriod) + " " + str(self.waveDirection) + " " + str(self.windDirection) + " " + str(self.windSpeed) + " " + str(self.tide)
